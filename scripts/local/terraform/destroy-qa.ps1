...
<#
.SYNOPSIS
    Destroy Terraform resources for QA environment
.DESCRIPTION
    Destroys all Terraform-managed resources in the qa environment
.EXAMPLE
    .\destroy-qa.ps1
#>
...
Write-Host "Terraform Destroy - QA Environment" -ForegroundColor Red
Write-Host "========================================" -ForegroundColor Red
Write-Host ""
...
Write-Host "========================================" -ForegroundColor Red
Write-Host "This will DESTROY all resources in QA environment:" -ForegroundColor Yellow
...
Write-Host ""
Write-Host "Type 'destroy-qa' to confirm destruction:" -ForegroundColor Red
$confirmation = Read-Host

if ($confirmation -eq "destroy-qa") {
    terraform apply tfplan-destroy-qa
    
    if ($LASTEXITCODE -eq 0) {
        Write-Host ""
        Write-Host "========================================" -ForegroundColor Green
        Write-Host "SUCCESS: QA environment destroyed!" -ForegroundColor Green
        Write-Host "========================================" -ForegroundColor Green
        
        Remove-Item tfplan-destroy-qa -ErrorAction SilentlyContinue
    } else {
