...
<#
.SYNOPSIS
    Apply Terraform configuration for QA environment
.DESCRIPTION
    Initializes and applies Terraform configuration for the qa environment
.EXAMPLE
    .\apply-qa.ps1
#>
...
Write-Host "Terraform Apply - QA Environment" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
terraform plan -var-file=$TFVARS_FILE -out=tfplan-qa
...
Write-Host "WARNING: This will create resources in AWS QA environment" -ForegroundColor Yellow
...
if ($confirmation -eq "yes") {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host "SUCCESS: QA environment deployed!" -ForegroundColor Green
        Write-Host "========================================" -ForegroundColor Green
        
        Remove-Item tfplan-qa -ErrorAction SilentlyContinue
    } else {
